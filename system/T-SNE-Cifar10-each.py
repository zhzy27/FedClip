...
if __name__ == "__main__":
    # 1766750615.868279  ce+mse
    # 1766750654.6227689  ce
    # 1766750627.044319 ce+con
    #1766738305.6300194  ce+con+mse
    
    model_path_dir="./temp/Cifar10/FedProto/1766738151.9820287"
    excel_result_dir="./T-SNE/FedProto/CIFAR10/Hetero/Test"
    # 使用统一表征空间的t-SNE
    for i in range(20):
        print("开始统一t-SNE降维...")
