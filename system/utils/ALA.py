...
class ALA:
    ...
    def adaptive_local_aggregation(self, 
        ...
        # obtain the references of the parameters  全局参数和本地参数（没有聚合状态字典）
        ...
        # preserve all the updates in the lower layers 低层直接覆盖
        ...
        while True:
            for x, y in rand_loader:
                ...
                # update weight in this batch 推导的梯度计算过程
        ...
        # obtain initialized local model 临时变量用于更新模型参数
