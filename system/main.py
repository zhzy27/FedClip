...
def run(args):
    ...
    for i in range(args.prev, args.times): # 可能跑多次取平均值
        ...
        # 不同系统异构程度实验
            ...
            args.models = [
                f'Hyper_CNN_512(in_features=3,  num_classes=args.num_classes,n_kernels=16, ratio_LR=0.9, input_size = {input_size}, rank_dropout_mode=args.rank_dropout_mode, rank_dropout_stage_start=args.rank_dropout_stage_start, rank_dropout_stage_end=args.rank_dropout_stage_end, rank_dropout_sandwich_min_capacity_prob=args.rank_dropout_sandwich_min_capacity_prob)', # 暂时只考虑一个秩
                f'Hyper_CNN_512(in_features=3,  num_classes=args.num_classes,n_kernels=16, ratio_LR=0.37, input_size = {input_size}, rank_dropout_mode=args.rank_dropout_mode, rank_dropout_stage_start=args.rank_dropout_stage_start, rank_dropout_stage_end=args.rank_dropout_stage_end, rank_dropout_sandwich_min_capacity_prob=args.rank_dropout_sandwich_min_capacity_prob)',
                f'Hyper_CNN_512(in_features=3,  num_classes=args.num_classes,n_kernels=16, ratio_LR=0.35, input_size = {input_size}, rank_dropout_mode=args.rank_dropout_mode, rank_dropout_stage_start=args.rank_dropout_stage_start, rank_dropout_stage_end=args.rank_dropout_stage_end, rank_dropout_sandwich_min_capacity_prob=args.rank_dropout_sandwich_min_capacity_prob)',
                f'Hyper_CNN_512(in_features=3,  num_classes=args.num_classes,n_kernels=16, ratio_LR=0.25, input_size = {input_size}, rank_dropout_mode=args.rank_dropout_mode, rank_dropout_stage_start=args.rank_dropout_stage_start, rank_dropout_stage_end=args.rank_dropout_stage_end, rank_dropout_sandwich_min_capacity_prob=args.rank_dropout_sandwich_min_capacity_prob)',
                f'Hyper_CNN_512(in_features=3,  num_classes=args.num_classes,n_kernels=16, ratio_LR=0.15, input_size = {input_size}, rank_dropout_mode=args.rank_dropout_mode, rank_dropout_stage_start=args.rank_dropout_stage_start, rank_dropout_stage_end=args.rank_dropout_stage_end, rank_dropout_sandwich_min_capacity_prob=args.rank_dropout_sandwich_min_capacity_prob)',
            ]
            args.global_model = f'Hyper_CNN_512(in_features=3,  num_classes=args.num_classes,n_kernels=16, ratio_LR=0.15, input_size = {input_size}, rank_dropout_mode=args.rank_dropout_mode, rank_dropout_stage_start=args.rank_dropout_stage_start, rank_dropout_stage_end=args.rank_dropout_stage_end, rank_dropout_sandwich_min_capacity_prob=args.rank_dropout_sandwich_min_capacity_prob)'
...
if __name__ == "__main__":
    ...
    parser.add_argument("--rank_dropout_mode", type=str, default="capacity",
                        choices=["original", "capacity", "staged", "sandwich", "none"],
                        help="Low-rank ordered dropout mode for Decom_CNN-5-512")
    parser.add_argument("--rank_dropout_stage_start", type=float, default=0.3,
                        help="Progress ratio where staged/sandwich dropout schedule starts changing")
    parser.add_argument("--rank_dropout_stage_end", type=float, default=0.8,
                        help="Progress ratio where staged/sandwich dropout schedule ends changing")
    parser.add_argument("--rank_dropout_sandwich_min_capacity_prob", type=float, default=0.5,
                        help="Minimum probability of capacity-aware rank sampling in the middle of sandwich dropout")
