...
def visualize_unified_tsne(tsne_df, save_dir):
    """简化的t-SNE可视化，为CIFAR-100使用不同颜色，没有图例"""
    ...
    # 保存图像
    plot_path = os.path.join(save_dir, "cifar100_tsne_visualization.pdf")
    plt.savefig(plot_path, dpi=300, bbox_inches='tight')
    plot_path = os.path.join(save_dir, "cifar100_tsne_visualization.png")
    plt.savefig(plot_path, dpi=300, bbox_inches='tight')
    plt.close()
...
if __name__ == "__main__":
    ...
    print("开始统一t-SNE降维...")
    unified_results = unified_tsne_across_clients(model_path_dr="./temp/Cifar100/FedHAS/1775734358.9692807",
                                num_clients=20,
                                excel_result_dir="./resnet/FedHAS/bn_no_mse",)
