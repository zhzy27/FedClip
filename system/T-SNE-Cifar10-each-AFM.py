...
def unified_tsne_across_clients(client_id,
                                model_path_dir="./temp/Cifar10/FedDAR/1764939710.7914877",
                                excel_result_dir="./T-SNE/DAT/CIFAR10/Hetero/Each/CE_MSE",
...
def visualize_all_clients_in_one_row(results_dir="./T-SNE/DAT/CIFAR10/Hetero/Each/CE_MSE", 
    ...
    # 添加总标题
    plt.suptitle('T-SNE Visualization for All Clients (CIFAR-10)', 
...
def create_detailed_legend(results_dir="./T-SNE/DAT/CIFAR10/Hetero/Each/CE_MSE"):
    """
    创建详细的图例说明图
    """
    ...
    for i, class_name in enumerate(cifar10_classes):
        color = color_palette(i/len(cifar10_classes))
...
if __name__ == "__main__":
    # 1764939710.5983057  ce+mse
    # 1764939710.7914877  ce
    # 1764939711.7900267 ce+con
    #1764939715.0951185  ce+con+mse
    
    model_path_dir="./temp/Cifar10/PFedAFM/1766738214.3735251"
    excel_result_dir="./T-SNE/PFedAFM/CIFAR10/Hetero/Each"
    # 使用统一表征空间的t-SNE
    for i in range(20):
        print("开始统一t-SNE降维...")
