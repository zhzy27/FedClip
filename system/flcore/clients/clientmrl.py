...
class clientMRL(Client):
    ...
    def train(self):
        ...
        # optimizer = torch.optim.SGD(model.parameters(), lr=self.learning_rate, weight_decay=0.0001)
        # optimizer_p = torch.optim.SGD(proj.parameters(), lr=self.learning_rate, weight_decay=0.0001)
        # optimizer_g = torch.optim.SGD(global_model.parameters(), lr=self.learning_rate, weight_decay=0.0001)
