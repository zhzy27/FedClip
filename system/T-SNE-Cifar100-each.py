...
if __name__ == "__main__":
    # 1766743446.3476748  ce
    # 1766743440.4759972  ce+mse
    # 1766743405.3052537 ce+con
    #1766628228.4946392  ce+con+mse  =
    model_path_dir="./temp/Cifar100/Local/1773394468.1473663"
    excel_result_dir="./T-SNE/each/Local/train"
    # 使用统一表征空间的t-SNE
    for i in range(20):
        print("开始统一t-SNE降维...")
