...
DATASET_CLASSES = {
    ...
    "tinyimagenet": [
        "goldfish", "european fire salamander", "bullfrog", "tailed frog", "american alligator",
        "boa constrictor", "green mamba", "african crocodile", "american chameleon", "komodo dragon",
        "triceratops", "african hunting dog", "hyena", "arabian camel", "goose",
        "black stork", "white stork", "black swan", "bustard", "albatross",
        "chicken", "ostrich", "brambling", "goldfinch", "house finch",
        "junco", "indigo bunting", "robin", "bulbul", "jay",
        "magpie", "chickadee", "water ouzel", "kite", "bald eagle",
        "vulture", "great grey owl", "sulphur-crested cockatoo", "lorikeet", "coucal",
        "bee eater", "hornbill", "hummingbird", "jacamar", "toucan",
        "drake", "red-breasted merganser", "canadian goose", "black-footed ferret", "polecat",
        "otter", "skunk", "badger", "armadillo", "three-toed sloth",
        "orangutan", "gorilla", "chimpanzee", "gibbon", "siamang",
        "guenon", "patas monkey", "baboon", "mandrill", "drill",
        "langur", "colobus", "proboscis monkey", "marmoset", "capuchin",
        "howler monkey", "titi monkey", "spider monkey", "squirrel monkey", "madagascar cat",
        "indri", "woolly indris", "aye-aye", "slow loris", "potto",
        "lesser panda", "giant panda", "barracouta", "eel", "coho salmon",
        "rock beauty", "anemone fish", "lionfish", "puffer", "abacus",
        "accordion", "acoustic guitar", "aircraft carrier", "airliner", "airship",
        "altar", "ambulance", "amphibious vehicle", "analog clock", "apiary",
        ...
        "barrel", "bathtub", "beach wagon", "beacon", "beaker",
        "bearskin hat", "beer bottle", "beer glass", "bell cote", "bib",
        ...
        "brassiere", "breakwater", "breastplate", "broom", "brown bear",
        "bubble", "bucket", "buckeye", "buckle", "bullet train",
        "bulletproof vest", "cab", "caboose", "caldron", "can opener",
        "candy store", "cannon", "canoe", "car wheel", "carbonated water",
        "carton", "cash machine", "cassette", "cassette player", "castle",
        "catamaran", "cd player", "cello", "cellular telephone", "centipede",
        "chain", "chain mail", "chain saw", "chest", "chiffonier",
        "chime", "china cabinet", "christmas stocking", "church", "cinema",
        "cleaver", "cliff dwelling", "cloak", "clog", "cocktail shaker",
        "coffee mug", "coffeepot", "coil", "combination lock", "comic book",
        "computer keyboard", "confectionery", "container ship", "convertible", "corkscrew",
        "cornet", "cowboy boot", "cowboy hat", "crab", "crayfish"
    ]
}
