...
if __name__ == "__main__":
    ...
    parser.add_argument("--rank_dropout_mode", type=str, default="dynamic_capacity",
                        ...
                        help="FedCLIP low-rank dropout mode. dynamic_capacity first uses full rank, then gradually switches to capacity-aware rank dropout; original uses the original random ordered dropout")
